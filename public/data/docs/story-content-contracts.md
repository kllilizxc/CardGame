...
4. Run `bun test src/game/scenes/worldmap/worldMap.test.ts src/game/scenes/startupFlow.test.ts` to validate the world-map data contract and `MainMenu -> WorldMapScene -> HubScene | ExpeditionScene -> WorldMapScene` routing/resume loop.
